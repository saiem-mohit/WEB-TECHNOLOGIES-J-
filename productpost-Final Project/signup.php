                    ...
                    <!-- <div id="check1"> -->
                        <!-- <div> -->
                            ...
                            <!-- <label> -->
                                ...
                                <!-- <input type="checkbox" value="Raw_Science" name='check[]' -->
                                       <!-- id="1">Raw -->
                                <!-- Science -->
                            <!-- </label> -->
                        <!-- </div> -->
                        ...
                        <!-- <div> -->
                            <!-- <label> -->
                                ...
                                <!-- <input type="checkbox" value="Computer_Science" name='check[]' -->
                                       <!-- id="2">Computer -->
                                <!-- Science -->
                            </label>
                        <!-- </div> -->
                        ...
                        <!-- <div> -->
                            ...
                            <!-- <label> -->
                                ...
                                <!-- <input type="checkbox" value="EEE" name='check[]' id="3">EEE -->
                            <!-- </label> -->
                        <!-- </div> -->
                        ...
                        <!-- <div> -->
                            ...
                            <!-- <label> -->
                                ...
                                <!-- <input type="checkbox" value="Others" name='check[]' id="4">Others -->
                            <!-- </label> -->
                        <!-- </div> -->
